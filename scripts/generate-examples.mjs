...
const COLLECTIONS = [
  {
    ...
    color: '#FFCB05',
    accent: '#E3350D',
    bgFiles: ['minimon-01.png', 'minimon-02.png'],
    backFile: 'back-minimon.png',
    desc: 'Pokémon-inspired creatures',
  },
  {
    id: 'dracobell',
    name: 'Dracobell',
    color: '#FF6B00',
    accent: '#FF4500',
    bgFiles: ['dracobell-01.png', 'dracobell-02.png'],
    backFile: 'back-dracobell.png',
    desc: 'Dragon Ball warriors',
  },
  {
    id: 'cybermon',
    name: 'Cybermon',
    color: '#00A1E9',
    accent: '#3B4CCA',
    bgFiles: ['cybermon-01.png', 'cybermon-02.png'],
    backFile: 'back-cybermon.png',
    desc: 'Digital monsters',
  },
];
